...
// WARNING: This is for local/private use only. Don't use on public sites without authentication!
...
async function loadBlogPosts() {
    try {
        ...
        snapshot.forEach(doc => {
            ...
            postElement.innerHTML = `
                ...
                <div class="item-actions">
                    <button class="btn btn-primary" onclick="editBlogPost('${doc.id}')">✏️ Edit</button>
                    <button class="btn btn-danger" onclick="deleteBlogPost('${doc.id}')">🗑️ Delete</button>
                </div>
            `;
        ...
        document.getElementById('blog-list').innerHTML = '<div class="loading">Error loading blog posts. Check console.</div>';
    }
}
    ...
    try {
        ...
        snapshot.forEach(doc => {
            ...
            productElement.innerHTML = `
                ...
                <div class="item-actions">
                    <button class="btn btn-primary" onclick="editProduct('${doc.id}')">✏️ Edit</button>
                    <button class="btn btn-danger" onclick="deleteProduct('${doc.id}')">🗑️ Delete</button>
                </div>
            `;
        ...
        document.getElementById('product-list').innerHTML = '<div class="loading">Error loading products. Check console.</div>';
    }
}
    ...
    try {
        ...
        snapshot.forEach(doc => {
            ...
            commentElement.innerHTML = `
                ...
                <div class="item-actions">
                    <button class="btn btn-danger" onclick="deleteComment('${doc.id}')">🗑️ Delete</button>
                </div>
            `;
        ...
        document.getElementById('comment-list').innerHTML = '<div class="loading">Error loading comments. Check console.</div>';
    }
}
